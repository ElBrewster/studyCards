...
Express Routing: basic function `app.METHOD(PATH, HANDLER)`
so,
...
[escape-htaml](https://www.npmjs.com/package/escape-html)
[path](https://www.npmjs.com/package/path)
[all from this, it looks wild](https://github.com/expressjs/express/blob/master/examples/markdown/index.js)

## On File Structure for Full-Stack App

[one fe server](https://stackoverflow.com/questions/62645706/what-is-an-appropriate-way-to-structure-the-directory-of-a-fullstack-application)
